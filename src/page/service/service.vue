 <template>
       <div class="rating_page">
        ...
        <section class="hot_questions" v-if="serviceData">
          ...
          <ul>
           <li v-for="(item,index) in questionTitle"
           :key="index" class="question_title"
                ...
                this.serviceData= await getService();
                 ...
                 Object.keys(this.serviceData).forEach(item=>{
                    ...
                    if (item.indexOf('Caption') !== -1 && !avoidRepeat) {
                        ...
                        this.questionDetail.push(this.serviceData[item]);//直接保存到详细里
                    }           
                 })                                              
            },
            //保存问题详细
...
@import "../../common/mixin";  
    ...
    .service_connect{
        ...
        a{
            ...
            svg{
                @include wh(1rem/$fensu, 1rem/$fensu);
            }
            span{
                margin-top: .4rem/$fensu;
    ...
    .hot_questions{
        .qustion_header{
            ...
            line-height: 3rem/$fensu;
            border-bottom: 1px solid #f5f5f5;
            padding-left: .7rem/$fensu;
        }
        .question_title{
            padding: 0 .7rem/$fensu;
            line-height: 2rem/$fensu;
            border-bottom: 1px solid #f5f5f5;
            @include fj;
            align-items: center;
            span{
