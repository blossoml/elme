...
@import '../../common/mixin';
    ...
    .container_style{
        ...
        padding: 0 .7rem/$fenmu;
    }
    .address_container{
        min-height: 3.5rem/$fenmu;
        @include fj;
        align-items: center;
        padding: 0 0.6rem/$fenmu;
        background: url(../../images/address_bottom.png) left bottom repeat-x;
        background-color: #fff;
        background-size: auto .12rem/$fenmu;
        .address_empty_left{
            display: flex;
            align-items: center;
            .location_icon{
            ...
            .address_detail_container{
                ...
                .address_detail{
                    ...
                    span{
                        ...
                        border-radius: .15rem/$fenmu;
                        background-color: #ff5722;
                        height: .6rem/$fenmu;
                        line-height: .6rem/$fenmu;
                        padding: 0 .2rem/$fenmu;
                        margin-right: .3rem/$fenmu;
                    }
                    p{
                        @include sc(.55rem/$fenmu, #777);
                    }
                }
            }
        }
    ...
    .address_empty_right{
        @include wh(.6rem/$fenmu, .6rem/$fenmu);
        fill: #999;
    }
    .delivery_model{
        border-left: .2rem/$fenmu solid $blue;
        min-height: 4rem/$fenmu;
        @include fj;
        align-items: center;
        .deliver_text{
            @include sc(.8rem/$fenmu, #333);
            font-weight: bold;
            padding-left: .3rem/$fenmu;
        }
        .deliver_time{
            display: flex;
            ...
            p:nth-of-type(1){
                @include sc(.7rem/$fenmu, $blue);
            }
            p:nth-of-type(2){
                @include sc(.5rem/$fenmu, #fff);
                background-color: $blue;
                width: 2.4rem/$fenmu;
                margin-top: .5rem/$fenmu;
                text-align: center;
                border-radius: 0.12rem/$fenmu;
                padding: .1rem/$fenmu;
            }
        }
    }
    .pay_way{
        .header_style{
            ...
            span:nth-of-type(1){
                @include sc(.7rem/$fenmu, #666);
            }
            .more_type{
                span:nth-of-type(1){
                    @include sc(.6rem/$fenmu, #aaa);
                    width: 10rem/$fenmu;
                ...
                svg{
                    @include wh(.5rem/$fenmu, .5rem/$fenmu);
                    fill: #ccc;
                }
            }
        }
        .hongbo{
            @include fj;
            border-top: 0.025rem/$fenmu solid #f5f5f5;
            span{
                @include sc(.6rem/$fenmu, #aaa);
                line-height: 2rem/$fenmu;
                svg{
    ...
    .food_list{
        ...
        header{
            padding: .7rem/$fenmu;
            border-bottom: 0.025rem/$fenmu solid #f5f5f5;
            img{
                @include wh(1.2rem/$fenmu, 1.2rem/$fenmu);
                vertical-align: middle;
            }
            span{
                @include sc(.8rem/$fenmu, #333);
    ...
    .confrim_order{
        ...
        p{
            line-height: 2rem/$fenmu;
            @include sc(.75rem/$fenmu, #fff);
        }
        p:nth-of-type(1){
            background-color: #3c3c3c;
            flex: 5;
            padding-left: .7rem/$fenmu;
        }
        p:nth-of-type(2){
            flex: 2;
    ...
    .choose_type_Container{
        ...
        ul{
            li{
                @include fj;
                padding: 0 .7rem/$fenmu;
                line-height: 2.5rem/$fenmu;
                align-items: center;
                span{
                    @include sc(.7rem/$fenmu, #ccc);
                }
                svg{
                    @include wh(.8rem/$fenmu, .8rem/$fenmu);
                    fill: #eee;
    ...
    .slid_up-enter, .slid_up-leave-active {
        transform: translate3d(0,10rem/$fenmu,0)
    }
