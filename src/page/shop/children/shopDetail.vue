...
<style lang="scss" scoped>
    ...
    .activities_container{
        ...
        margin: .4rem/$fensu 0;
        padding-bottom: .6rem/$fensu;
        header{
            @include sc(.75rem/$fensu, #333);
            line-height: 1.8rem/$fensu;
            padding-left: .6rem/$fensu;
            border-bottom: 1px solid #f1f1f1;
            margin-bottom: .3rem/$fensu;
        }
        .actibities_ul{
            padding: 0 .6rem/$fensu;
            li{
                margin-bottom: .2rem/$fensu;
                span:nth-of-type(1){
                    @include sc(.45rem/$fensu, #fff);
                    padding: .1rem/$fensu;
                    border: 1px;
                    border-radius: 0.1rem/$fensu;
    ...
    .shop_status_container{
        ...
        .shop_status_header{
            ...
            .identification_detail{
                @include sc(.7rem/$fensu, #bbb);
                vertical-align: middle;
            }
            svg{
                @include wh(.6rem/$fensu, .6rem/$fensu);
                vertical-align: middle;
            }
        }
        .shop_statu_detail{
            ...
            padding: .6rem/$fensu;
            svg{
                @include wh(2rem/$fensu, 2rem/$fensu);
                margin-right: .6rem/$fensu;
            }
            .check_date{
                span{
                    @include sc(.55rem/$fensu, #666);
    ...
    .shop_status_info{
        ...
        p{
            @include sc(.6rem/$fensu, #666);
            padding: .7rem/$fensu .6rem/$fensu .7rem/$fensu 0;
            margin-left: .6rem/$fensu;
            border-bottom: 0.025rem/$fensu solid #f5f5f5;
        }
        span{
            color: #666;
        }
    ...
    .router-slid-enter, .router-slid-leave-to {
        transform: translate3d(2rem/$fensu, 0, 0);
        opacity: 0;
    }
</style>
