...
export default {
	...
	[ADD_CART](state,{
		...
		let cart =state.cartList;//加入购物车的商品列表
		/**
		 * shopid空对象
		 * category_id shopid item_id	
		 */
		let shop=cart[shopid]= (cart[shopid] || {});//店铺shopid
	...
	[CONFIRM_REMARK](state, {
		...
		state.remarkText=remarkText;//可选备注内容
		state.inputText=inputText;//输入备注内容
	},
	//选择搜索的地址
